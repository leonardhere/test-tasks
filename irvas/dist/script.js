  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      postData('assets/server.php', formData).then(function (res) {
        ...
        return statusMessage.textContent = message.failture;
      }).finally(function () {
        clearInputs();
        setTimeout(function () {
...
var modals = function modals() {
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    trigger.forEach(function (item) {
      item.addEventListener('click', function (e) {
        ...
        document.body.style.overflow = "hidden"; // document.body.classList.add('modal-open')Selector
      });
    });
  ...
  bindModal('.popup_calc_profile_button', '.popup_calc_end', '.popup_calc_and_close', false); // showModalByTime('.popup', 60000)
};
